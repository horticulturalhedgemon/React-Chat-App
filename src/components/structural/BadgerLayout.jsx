...
function BadgerLayout(props) {
    ...
    //if loginstatus exists and is true
    const [loginStatus, setLoginStatus] = useState(('loginStatus' in sessionStorage && sessionStorage.getItem('loginStatus')))
    if (!('loginStatus' in sessionStorage)) {
        sessionStorage.setItem('loginStatus',false)
        sessionStorage.setItem('username',false)
    }
    //finding chatroom names: feels redundant,  but whatever
